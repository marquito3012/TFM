...
Al haberse verificado sin fisuras cada uno de estos cinco hitos metodológicos, se dictamina que el \textbf{Objetivo General} ---desarrollar un \textit{framework} basado en aprendizaje profundo capaz de eludir la crisis del Time-to-Data hospitalario preservando la privacidad irrestricta de los ciudadanos--- ha sido coronado con un éxito ingenieril absoluto.

\section{Limitaciones del Estudio}

A pesar de la excelencia empírica cosechada, la investigación adolece de limitaciones inherentes a la tecnología de difusión contemporánea que impiden catalogarla como un sistema libre de fricciones.
...
Resultaría injusto no expresar un sincero agradecimiento al equipo docente del Máster, cuya perseverancia ha elevado sistemáticamente mis estándares académicos, y de manera particular, a mi tutor y círculo cercano, cuya paciencia incombustible brindó el soporte emocional necesario para atravesar los áridos desiertos de los errores de compilación algorítmica.

\begin{citaLiteralAPA}
Para concluir, no puedo terminar este proyecto sin reflejar mi deseo inquebrantable de que el celo por la ciberseguridad nunca más actúe como una guillotina para el avance biomédico. Confío en que, en el futuro cercano, las arquitecturas de síntesis de datos de código abierto terminen por dinamitar los silos de información privados, logrando que el conocimiento necesario para curar patologías críticas, como la diabetes, fluya libremente entre los investigadores de todo el globo terráqueo. Por mi parte, espero sinceramente que esta humilde pero rigurosa contribución tecnológica suponga un eslabón firme hacia esa utopía.
\end{citaLiteralAPA}
