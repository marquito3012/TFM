...
# 1. Definición del Hardware (GPU / CUDA-Compatible)
...
tabddpm_config = {
    ...
    'hidden_dims': [512, 512, 512],# Capas de los ResBlocks
    'lr': 1e-3,
    'weight_decay': 1e-4
}

# 3. Inicialización del Preprocesador Tabular y Codificación Mixta
# (Convierte las 9 continuas vía StandardScaler y las 30 categóricas vía OHE a 139-dim)
...
# 5. Instanciación de la Red de Denoising (1.097.483 parámetros entrenables)
...
# 7. Ejecución del Entrenamiento (Difusión de Markov con T=1000 pasos de ruido)
